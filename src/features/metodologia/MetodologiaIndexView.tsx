      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {MANUALES.map((manual) => (
          <Link
            key={manual.to}
            to={manual.to}
            className="flex flex-col gap-2 rounded-xl border border-slate-200 bg-white p-4 transition-colors hover:border-union-red-300 hover:text-union-red-600 dark:border-slate-700 dark:bg-slate-900"
          >
